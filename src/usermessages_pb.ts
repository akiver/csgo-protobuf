...
export class CUserMsg_ParticleManager extends Message<CUserMsg_ParticleManager> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    { no: 1, name: "type", kind: "enum", T: proto2.getEnumType(PARTICLE_MESSAGE), req: true, default: PARTICLE_MESSAGE.GAME_PARTICLE_MANAGER_EVENT_CREATE },
...
export class CUserMessage_Inventory_Response extends Message<CUserMessage_Inventory_Response> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    ...
    { no: 15, name: "start_time", kind: "scalar", T: 3 /* ScalarType.INT64 */, opt: true },
  ]);
...
export class CUserMessageRequestDiagnostic_Diagnostic extends Message<CUserMessageRequestDiagnostic_Diagnostic> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    ...
    { no: 13, name: "context", kind: "scalar", T: 5 /* ScalarType.INT32 */, opt: true },
  ]);
...
export class CUserMessage_Diagnostic_Response extends Message<CUserMessage_Diagnostic_Response> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    ...
    { no: 4, name: "start_time", kind: "scalar", T: 3 /* ScalarType.INT64 */, opt: true },
    { no: 5, name: "osversion", kind: "scalar", T: 5 /* ScalarType.INT32 */, opt: true },
    { no: 6, name: "platform", kind: "scalar", T: 5 /* ScalarType.INT32 */, opt: true },
  ]);
...
export class CUserMessage_Diagnostic_Response_Diagnostic extends Message<CUserMessage_Diagnostic_Response_Diagnostic> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    ...
    { no: 10, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
    { no: 11, name: "alias", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
    { no: 12, name: "backup", kind: "scalar", T: 12 /* ScalarType.BYTES */, opt: true },
    { no: 13, name: "context", kind: "scalar", T: 5 /* ScalarType.INT32 */, opt: true },
    { no: 14, name: "control", kind: "scalar", T: 3 /* ScalarType.INT64 */, opt: true },
    { no: 15, name: "augment", kind: "scalar", T: 3 /* ScalarType.INT64 */, opt: true },
    { no: 16, name: "placebo", kind: "scalar", T: 3 /* ScalarType.INT64 */, opt: true },
  ]);
