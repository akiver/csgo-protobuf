...
export class FieldDescriptorProto extends Message<FieldDescriptorProto> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    ...
    { no: 4, name: "label", kind: "enum", T: proto2.getEnumType(FieldDescriptorProto_Label), opt: true, default: FieldDescriptorProto_Label.OPTIONAL },
    { no: 5, name: "type", kind: "enum", T: proto2.getEnumType(FieldDescriptorProto_Type), opt: true, default: FieldDescriptorProto_Type.DOUBLE },
