...
export const CMsgRecurringMissionSchema_MissionTemplateListSchema: GenMessage<CMsgRecurringMissionSchema_MissionTemplateList> = /*@__PURE__*/
  messageDesc(file_cstrike15_gcmessages, 154, 0);
